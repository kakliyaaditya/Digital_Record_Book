...
<img src="https://prorehablou.com/wp-content/uploads/2014/11/default-profile-photo-300x300.jpg" style="float:left;width:45px;height:45px;margin:5px">    
...
<form id="myform" method ="get" action="Assign.jsp" target="frame1" onsubmit="return isOneChecked1()">
    <br>
    <% while (i < count) {
            String temp = arr[i];%>
     <input type="radio" class="option-input radio" name ="grpname"  value="<%=arr[i]%>">
    <%
            out.println(temp);
    %>
    ...
    %>
    <input type="submit" class="btn first" value="Get Assignments"  id='ajaxcall'>  
</form>
...
<form action="AssignCreate" method="get" target="frame1">
    <div id="AssignNumber" style="display: none">
        Create Assignment Number ?
        <select onclick="assigncreate()" id="selectNumber" class="btn" name="AssignNumber">
            <%
                for (i = 1; i < 11; i++) {
            %>
            <option value="<%out.println(i);%>" onclick="validate()" class="btn">Assignment <%out.println(i);%></option>
            <%
        ...
        <input type="hidden" name="username" value="<%out.println(teacher);%>">
...
<form action="DeleteAssign" method="get" target="frame1">

    <div id="assignno" style="display: none">
        Delete Assignment Number ?
        <select id="selectNumber" name="AssignNumber" class="btn">
            <%
                for (i = 1; i < 11; i++) {
            %>
            <option value="<%out.println(i);%>" class="btn" onclick="validate()">Assignment <%out.println(i);%></option>
            <%
        ...
        <input type="submit" class="btn" value="Delete Assignment">
        <br> 
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <p style="color:#000;">Some text in the Modal..<br>Some text in the Modal..<br>Some text in the Modal..<br></p>
  </div>
...
%>
<form action="TestMarks.jsp" target="frame1" method="get" onsubmit="return isOneChecked2()">
    <%        for (int i = 0; i < num; i++) {
            String temp = classes[i];
    %>
            <input type="radio" class="option-input radio" name ="subjectName"  value="<%=classes[i]%>">
    <br><br>
    <%
            out.println(temp);
...
<button id="student" onclick="getrollno()" class="btn">Search Student </button>
<br>


<form name="meechTo" id="getnum" action="StudentRecord.jsp" target="frame1" onsubmit="return isRollWritten() " style="display: none">

    <input type="text" style="width:50%"  name="studRollNo" > <br>   
    <input type="submit" class="btn" value="Get Record" onclick="return rollWrittenProperly()">
    <br>
</form>
