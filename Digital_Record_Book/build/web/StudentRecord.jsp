...
td{
  ...
  border-bottom: solid 1px rgba(0,0,0,1);
		...
		%>
                ...
                <h3><%out.println("Subjecct :  SL - "+SubjectCode);%></h3>
                
                <center><h2><%out.println("Roll No. : "+rollNo);%></h2></center>
		...
		<table class="table" id="data-table" cellpadding="10px" cellspacing="20px" style="border : 1px solid #000">
		    ...
		    <tr>
		       ...
		       <%}else {%>
		        ...
		        <%
		            if (studRecord[i][4].equals("1")) {
		        %><td><input type="checkbox" class="option-input checkbox"   name="check_arr" value="<%out.println(studRecord[i][0]);%> " checked ><br><br> </td>
		            <% } else { %>  
		        <td><input type="checkbox" class="option-input checkbox"   name="check_arr" value="<%out.println(studRecord[i][0]);%>" ><br><br> </td>               
		        <%  } %>
		    </tr><% }
		        %>
		</table>
		...
		<input type="submit" style="width : 20%" class="btn" onClick=" $(this).MessageBox();" value="submit">
