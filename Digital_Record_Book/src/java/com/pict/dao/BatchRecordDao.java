...
public class BatchRecordDao {
    ...
    public void report(String username, String grpname, int report1[][]) throws SQLException {
        ...
        String query2 = "select SubjectCode from UserInfo where UserID ='" + username.trim() + "' and GroupCode=" + gcode + ";";
        ...
        String query3 = "select StartRollNo,EndRollNo from GroupTable where GroupCode=(select GroupCode from GroupTable where GroupName='" + grpname.trim() + "');";
        ...
        while (startnum <= endnum) {
            ...
            while (rs.next()) {
                ...
                String query6 = "select Marks from " + temp.trim() + " where Rollno =" + startnum + " and SubjectCode=" + subjectCode + " ;";
