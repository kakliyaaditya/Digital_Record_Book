...
public class CreateTableDao {
    ...
    public void updateDate(String uname, String AssignName, String date) throws SQLException {
        ...
        String query1 = "update " + finalAname.trim() + " set ScheduledDate='" + date.trim() + "' where SubjectCode=(select distinct UserInfo.SubjectCode from SubjectCoordinator,UserInfo,GroupTable where SubjectCoordinator.UserID=UserInfo.UserID and UserInfo.GroupCode=GroupTable.groupCode and SubjectCoordinator.UserID='"+uname.trim()+"' and GroupTable.EndRollno-GroupTable.StartRollNo<20);";
