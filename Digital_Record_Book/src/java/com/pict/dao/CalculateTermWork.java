...
public class CalculateTermWork {
    ...
    public ResultSet termWork(String username, String groupname) throws ClassNotFoundException, SQLException {
        ...
        String query5 = "select StartRollNo,EndRollNo from GroupTable where GroupCode=(select GroupCode from GroupTable where GroupName='" + groupname.trim() + "');";
        ...
        while (endnum >= startnum) {
            ...
            String query4 = "select sum(UT1),sum(UT2),sum(OutOfMarks) from UnitTest where RollNo=" + startnum + " and SubjectCode=any(select SubjectCode from UserInfo where UserID='" + username.trim() + "') ;";
            ...
            if (rs3.next()) {
                ...
                sum1 += Integer.parseInt(rs3.getString("sum(UT1)"));
            ...
            String query2 = "select SubjectCode from UserInfo where UserID='" + username.trim() + "' and GroupCode=(select GroupCode from GroupTable where GroupName='" + groupname.trim() + "' and EndRollNo-StartRollNo<20);";
            ...
            while (rs.next()) {
                ...
                String query6 = "select Marks,Approved from " + temp.trim() + " where Rollno =" + startnum + " and SubjectCode=" + subjectCode + " ;";
