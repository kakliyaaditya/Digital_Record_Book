...
public static String rn, marks1,marks2;
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       while( i < 80) {
        ...
        Marks1 =  Integer.parseInt(MARKS1.getJSONObject("").getJSONArray("").getJSONObject(i).getString("Unit Test 1"));
        Marks2 =  Integer.parseInt(MARKS2.getJSONObject("").getJSONArray("").getJSONObject(i).getString("Unit Test 2"));
        
        updatedb(); 
        i++;
         }
        
         out.println("Successfully Updated Marks");
